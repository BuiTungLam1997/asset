                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="<c:url value="/admin-search-model"/>" method="get" id="formSearch">
                                    <input type="text" placeholder="Search.." name="search" id="search" value="">
                                    <button type="submit" onclick="fun()" id="btnSearch">Submit
                                    </button>
                                </form>

                                <form action="<c:url value="/admin-model-list"/>" id="formSubmit" method="get">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <c:url var="createUserURL" value="/admin/model-edit"/>
                                            <a flag="info"
...
<script type='text/javascript' src="/template/custom/admin/js/model/list.js"></script>
    ...
    function deleteAsset(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = '/admin/model-list?&message=delete_success';
            },
            error: function (error) {
                window.location.href = '/admin/model-list?&message=error!';
            },
        });
    }
</script>
