            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="note"> Ghi chu </label>
...
<script type='text/javascript' src="/template/custom/admin/js/group/edit.js"></script>
</body>
</html>
